...
export interface ApiPanoramaPanorama extends Schema.CollectionType {
...
export interface ApiProfileProfile extends Schema.CollectionType {
  ...
  attributes: {
    ...
    nombre_apellidos: Attribute.String &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
